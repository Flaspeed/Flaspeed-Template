...
if(!isMobileTooltip){
    (function() {
        ...
        Tooltip.prototype.attachEvents = function(targetEl, tooltipEl, backdropEl) {
          ...
          const showTooltip = () => {
            // أهم تغيير: إعادة حساب الموضع في كل مرة يُظهر فيها التلميح
          ...
          targetEl.addEventListener('pointerenter', (e) => {
            clearTimeout(hoverTimeout); // تنظيف أي مؤقت سابق
          ...
          // إضافة مستمع لتحديث موضع tooltip عند تمرير الصفحة
          ...
          // إضافة مستمع لتحديث موضع tooltip عند تغيير حجم النافذة
