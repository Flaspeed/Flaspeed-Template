...
function setSlides(slider, widgetId, type, perPage, pagination, arrows, gap, breakpointsEnabled, ...rest) {
  ...
  new Splide(elem, KA).on('mounted', () => {
    ...
    if (elem.classList.contains('services-wrapper')) {
      LazyImages("data-service-src");
    }
    if (elem.classList.contains('m-slider')) {
      LazyImages('data-slider-src');
      loadClass();
    }
...
htmlContent += '<'+sectionType+' class="cates '+element.getAttribute("data-type")+ splideList +'" '+roleFeed+'>';
...
htmlContent += '<h3 role="heading" class="catstitle"><a href="'+catsLink+'" title="'+catsLabel+'">'+catsLabel+'</a></h3>';
}
...
htmlDet += !mega ? D1.AuthNameLink : '',
htmlDet += D1.LinkDate,
htmlDet += D1.NumComUrl;
return htmlDet + '</div>';
}
htmlContent += '<'+articleType+' class="post post-'+ i + splideSlide + " " + animDir +'" '+roleArticle+' data-item="'+D1.PostId+'" data-cate="'+D1.Category+'">';
...
htmlContent += '<img alt="'+D1.FullTitle+'" data-slider-src="'+D1.ImgUrl+'"/>',
htmlContent += '</a>',
htmlContent += '<button aria-label="Read it Later" class="snackbar-btn tooltipped postSave" data-tooltip="اقرأها لاحقا" type="button" data-duration="4000">',
htmlContent += '<svg fill="none" height="16" stroke="var(--key)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="16"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>',
htmlContent += '</button>',              
...
htmlContent += '<div class="post-image">',
htmlContent += '<a title="'+D1.FullTitle+'" class="image Lazy" href="'+D1.Link+'">',
htmlContent += '<img alt="'+D1.FullTitle+'" data-staticslider-src="'+D1.ImgUrl+'"/>',
htmlContent += '</a>',
htmlContent += '<button aria-label="Read it Later" class="snackbar-btn tooltipped postSave" data-tooltip="اقرأها لاحقا" type="button" data-duration="4000">',
htmlContent += '<svg fill="none" height="16" stroke="var(--key)" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" viewBox="0 0 24 24" width="16"><path d="M19 21l-7-5-7 5V5a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2z"></path></svg>',
htmlContent += '</button>',              
...
====================== */
if(allcats){
htmlContent += '<h4 role="heading" class="post-title"><a title="'+D1.FullTitle+'" href="'+D1.Link+'">'+D1.Title+'</a></h4>';
}
...
LazyImages('data-staticslider-src');
gtSlider(() => {
